...
import * as Book from "../database/controllers/bookControllers.js"
...
router.get("/detail/:id", Book.bookDetail);

router.get("/review/:id", Book.bookReviewList);

router.post("/review/:id", Book.bookReviewPost);

router.delete("/review/:id", Book.bookReviewDelete);

router.patch("/like/:id", Book.bookLikeToggle)

router.get("/test/:id", Book.bookTest);
